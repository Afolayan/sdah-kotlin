...
public class Splash extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SdahYoruba.getInstance().trackScreenView("Splash");
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        // are available.
        delayedHide(100);
//        new LoadDataFromFile().execute();
        AppHelper.loadHymnDataFromFile(Splash.this);
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {

                startActivity(new Intent(Splash.this, NewDashBoardActivity.class));
                Splash.this.finish();
    ...
    public class LoadDataFromFile extends AsyncTask<Void, Void, Void>{
